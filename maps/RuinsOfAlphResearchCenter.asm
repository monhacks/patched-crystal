...
.GiveAerodactyl:
	...
	waitsfx
	waitbutton
	givepoke AERODACTYL, 30, BERSERK_GENE
	closetext
	end
...
.GiveKabuto:
	...
	givepoke KABUTO, 30, BERSERK_GENE
	closetext
	end
...
.GiveOmanyte:
	...
	givepoke OMANYTE, 30, BERSERK_GENE
	closetext
	end
...
RuinsOfAlphResearchCenter_MapEvents:
	...
	object_event  1,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_WANDER, 2, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FossilScientist, -1
