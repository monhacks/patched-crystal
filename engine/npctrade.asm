...
ENDM
	...
	;ZAPDOS npctrade 0, ABRA,       MACHOP,     "MUSCLE@@@@@", $37, $66, GOLD_BERRY,   37460, "MIKE@@@@@@@", TRADE_EITHER_GENDER
	npctrade 0, ELECTABUZZ, ZAPDOS,     "ZAPDOS@@@@@", $37, $66, MAGNET,   37460, "MIKE@@@@@@@", TRADE_EITHER_GENDER
	;MOLTRES npctrade 0, BELLSPROUT, ONIX,       "ROCKY@@@@@@", $96, $66, BITTER_BERRY, 489 26, "KYLE@@@@@@@", TRADE_EITHER_GENDER
	npctrade 0, MAGMAR,  MOLTRES,       "MOLTRES@@@@", $96, $66, CHARCOAL, 48926, "KYLE@@@@@@@", TRADE_EITHER_GENDER
	;ARTICUNO npctrade 1, KRABBY,     VOLTORB,    "VOLTY@@@@@@", $98, $88, PRZCUREBERRY, 29189, "TIM@@@@@@@@", TRADE_EITHER_GENDER
	npctrade 1, JYNX,     ARTICUNO,    "ARTICUNO@@@", $98, $88, NEVERMELTICE, 29189, "TIM@@@@@@@@", TRADE_EITHER_GENDER
	npctrade 3, DRAGONAIR,  DODRIO,     "DODRIO@@@@@", $77, $66, SMOKE_BALL,   00283, "EMY@@@@@@@@", TRADE_FEMALE_ONLY
	;MEW npctrade 2, HAUNTER,    XATU,       "PAUL@@@@@@@", $96, $86, MYSTERYBERRY, 15616, "CHRIS@@@@@@", TRADE_EITHER_GENDER
	npctrade 2, DITTO,    MEW,       "MEW@@@@@@@@", $96, $86, MYSTERYBERRY, 15616, "CHRIS@@@@@@", TRADE_EITHER_GENDER
	npctrade 3, CHANSEY,    AERODACTYL, "AERODACTYL@", $96, $66, GOLD_BERRY,   26491, "KIM@@@@@@@@", TRADE_EITHER_GENDER
	;MEWTWO npctrade 0, DUGTRIO,    MAGNETON,   "MAGGIE@@@@@", $96, $66, METAL_COAT,   50082, "FOREST@@@@@", TRADE_EITHER_GENDER
	npctrade 0, PORYGON2,    MEWTWO,   "MEWTWO@@@@@", $96, $66, BERSERK_GENE,   50082, "FOREST@@@@@", TRADE_EITHER_GENDER
; fcf38
