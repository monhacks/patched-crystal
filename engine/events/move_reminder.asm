...
Text_MoveReminderIntro:
	text MoveReminderIntroText
	end
	
Text_MoveReminderWhichMon:
	text MoveReminderWhichMonText
	end

Text_MoveReminderWhichMove:
	text MoveReminderWhichMove
	end

Text_MoveReminderCancel:
	text MoveReminderRefusedText
	end
	
Text_MoveReminderEgg:
	text MoveReminderEgg
	end

Text_MoveReminderNoMon:
	text MoveReminderNoMon
	end
