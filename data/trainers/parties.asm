...
FalknerGroup:
	...
	db 68, PIDGEOT,     SHARP_BEAK,	  RAZOR_WIND, MUD_SLAP, SKY_ATTACK, WING_ATTACK
	db 65, FEAROW,		SHARP_BEAK,	  DRILL_PECK, PURSUIT, DETECT, STEEL_WING
	db 63, NOCTOWL,		TWISTEDSPOON,	  DREAM_EATER, HYPNOSIS, NIGHTMARE, FLY
	db 65, MURKROW,		SHARP_BEAK,	  MEAN_LOOK, PURSUIT, NIGHT_SHADE, STEEL_WING
...
WhitneyGroup:
	...
	db 68, TOGETIC,		PINK_BOW,  	DOUBLE_EDGE, SAFEGUARD, SWEET_KISS, HYPER_BEAM
	db 64, GIRAFARIG,	TWISTEDSPOON,  CRUNCH, THUNDERBOLT, PSYCHIC_M, ATTRACT
	db 65, FURRET,		PINK_BOW,  	DOUBLE_EDGE, SWIFT, AMNESIA, REST
	db 68, BLISSEY,		MIRACLEBERRY,  HEAL_BELL, EGG_BOMB, SOFTBOILED, HYPER_BEAM
	db 65, CLEFABLE,    PINK_BOW, 	DOUBLESLAP, MIMIC, ENCORE, METRONOME
...
BugsyGroup:
	...
	db 67, BEEDRILL,    SILVERPOWDER,   	SLUDGE_BOMB, AGILITY, FURY_CUTTER, PIN_MISSILE
	db 65, ARIADOS,		TWISTEDSPOON,	  	PSYCHIC_M, SPIDER_WEB, SLUDGE_BOMB, GIGA_DRAIN
	db 68, HERACROSS,	SILVERPOWDER,	  	MEGAHORN, DETECT, ROCK_SMASH, EARTHQUAKE
	db 64, YANMA,		MIRACLE_SEED,	  	TOXIC, GIGA_DRAIN, DETECT, FLASH
...
MortyGroup:
	...
	db 65, GASTLY,     SPELL_TAG, LICK, SPITE, MEAN_LOOK, CURSE
	db 67, HAUNTER,    SPELL_TAG, HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
...
PryceGroup:
	...
	db 67, SEEL,      NEVERMELTICE, HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	...
	db 67, PILOSWINE, NEVERMELTICE, ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 66, MAGNEMITE, MAGNET, THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	...
	db 70, STEELIX,   METAL_COAT,  SCREECH, CRUNCH, ROCK_SLIDE, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 67, PRIMEAPE, 	BLACKBELT_I,  ROCK_SMASH, RAGE, CROSS_CHOP, FURY_SWIPES
	db 67, HITMONCHAN, 	BLACKBELT_I,  ROCK_SMASH, COUNTER, THUNDERPUNCH, MACH_PUNCH
	...
	db 70, POLIWRATH,   BLACKBELT_I,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
ClairGroup:
	...
	db 67, DRAGONAIR,  DRAGON_FANG, THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 67, DRAGONITE,  DRAGON_FANG, THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 68, DRAGONITE,  DRAGON_FANG, THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 67, GYARADOS,   DRAGON_FANG, ROAR, HYPER_BEAM, TWISTER, DRAGONBREATH
	db 70, KINGDRA,    DRAGON_FANG, SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
BrockGroup:
	...
	db 64, GOLEM,      HARD_STONE, DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 66, RHYHORN,    SOFT_SAND, FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 63, OMASTAR,    GOLD_BERRY, BITE, SURF, PROTECT, SPIKE_CANNON
	db 68, STEELIX,    HARD_STONE,  BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 65, SUDOWOODO,  GOLD_BERRY, ROCK_SLIDE, HIDDEN_POWER, THUNDERPUNCH, EARTHQUAKE
	db 65, KABUTOPS,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end
...
MistyGroup:
	...
	db 68, SLOWKING,   MYSTIC_WATER, PSYCHIC_M, SURF, BUBBLEBEAM, THUNDER_WAVE
	db 70, STARMIE,    MYSTIC_WATER, SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end
...
LtSurgeGroup:
	...
	db 65, ELECTRODE,  MAGNET,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
ErikaGroup:
	...
	db 64, TANGELA,    MIRACLE_SEED, VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 65, JUMPLUFF,   MIRACLE_SEED, MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 66, VICTREEBEL, MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 66, BELLOSSOM,  MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
...
JanineGroup:
	...
	db 64, WEEZING,    POISON_BARB, SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 67, ARIADOS,    POISON_BARB, SCARY_FACE, GIGA_DRAIN, PSYCHIC_M, NIGHT_SHADE
	db 66, MUK,	  	   POISON_BARB, SLUDGE_BOMB, ACID_ARMOR, TOXIC, MINIMIZE
	db 69, VENOMOTH,   POISON_BARB, FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	db 66, ESPEON,     TWISTEDSPOON, SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db 66, HYPNO,	   TWISTEDSPOON, BARRIER, LIGHT_SCREEN, METRONOME, PSYCHIC_M
	db 66, XATU,	   TWISTEDSPOON, PSYCHIC_M, CONFUSE_RAY, NIGHT_SHADE, PROTECT
	db 68, SLOWKING,   MYSTIC_WATER, PSYCHIC_M, SURF, BUBBLEBEAM, THUNDER_WAVE
	db 66, MR__MIME,   TWISTEDSPOON, BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
...
BlaineGroup:
	...
	db 65, FLAREON,    CHARCOAL, FLAMETHROWER, SHADOW_BALL, CURSE, SUNNY_DAY
	db 67, MAGCARGO,   CHARCOAL, CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
	db 65, MAGMAR,     CHARCOAL, THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 70, RAPIDASH,   CHARCOAL, QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
