...
; ================
	...
	;db 50, TYPHLOSION
	;db 50, FERALIGATR
	db 60, FERALIGATR, BERSERK_GENE
		db HYDRO_PUMP
		db DYNAMICPUNCH
		db SURF
		db CRUNCH
		
	db 60, SKARMORY, SHARP_BEAK
		db STEEL_WING
		db PROTECT
		db SANDSTORM
		db SKY_ATTACK
		
	db 60, TOGETIC, SCOPE_LENS
		db SAFEGUARD
		db HYPER_BEAM
		db ICE_BEAM
		db FLAMETHROWER
		
	db 60, PILOSWINE, MIRACLEBERRY
		db BLIZZARD
		db ANCIENTPOWER
		db EARTHQUAKE
		db ICY_WIND
		
	db 60, ARIADOS, POISON_BARB
		db SLUDGE_BOMB
		db AGILITY
		db PSYCHIC
		db NIGHT_SHADE
		
	db 60, GENGAR, SPELL_TAG
		db SHADOW_BALL
		db NIGHT_SHADE
		db TOXIC
		db DESTINY_BOND
...
; COOLTRAINERF (22)
	...
	db 75, UMBREON, BLACKGLASSES
		db PURSUIT
		db FAINT_ATTACK
		db MOONLIGHT
		db SCREECH

	db 70, MURKROW, BLACKGLASSES
		db PURSUIT
		db FAINT_ATTACK
		db NIGHT_SHADE
		db MEAN_LOOK
	
	db 77, HOUNDOOM, CHARCOAL
		db ROAR
		db FAINT_ATTACK
		db FLAMETHROWER
		db CRUNCH
	
	db 75, SNEASEL, BLACKGLASSES
		db SCREECH
		db FAINT_ATTACK
		db BEAT_UP
		db METAL_CLAW
	
	db 78, TYRANITAR, PINK_BOW
		db ROCK_SLIDE
		db CRUNCH
		db EARTHQUAKE
		db HYPER_BEAM
	
	db 80, GENGAR, SPELL_TAG
		db NIGHT_SHADE
		db SHADOW_BALL
		db HYPNOSIS
		db DESTINY_BOND
...
; COOLTRAINERF (23)
	...
	db 80, UMBREON, BLACKGLASSES
		db PURSUIT
		db FAINT_ATTACK
		db MOONLIGHT
		db SCREECH

	db 78, MURKROW, BLACKGLASSES
		db PURSUIT
		db FAINT_ATTACK
		db NIGHT_SHADE
		db MEAN_LOOK
	
	db 85, HOUNDOOM, CHARCOAL
		db ROAR
		db FAINT_ATTACK
		db FLAMETHROWER
		db CRUNCH
	
	db 83, SNEASEL, BLACKGLASSES
		db SCREECH
		db FAINT_ATTACK
		db BEAT_UP
		db METAL_CLAW
	
	db 90, TYRANITAR, PINK_BOW
		db ROCK_SLIDE
		db CRUNCH
		db EARTHQUAKE
		db HYPER_BEAM
	
	db 90, GENGAR, SPELL_TAG
		db NIGHT_SHADE
		db SHADOW_BALL
		db HYPNOSIS
		db DESTINY_BOND
