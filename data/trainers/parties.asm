...
JasmineGroup:
	...
	db 65, SKARMORY,  METAL_COAT,	  DRILL_PECK, SPIKES, SKY_ATTACK, STEEL_WING
...
ClairGroup:
	...
	db 67, DRAGONAIR,  DRAGON_FANG, THUNDER_WAVE, THUNDERBOLT, FLAMETHROWER, DRAGONBREATH
	db 67, DRAGONITE,  DRAGON_FANG, THUNDER, SAFEGUARD, HYPER_BEAM, DRAGONBREATH
	db 68, CHARIZARD,  DRAGON_FANG, FLAMETHROWER, WING_ATTACK, SLASH, DRAGONBREATH
	db 67, AERODACTYL, DRAGON_FANG, ROCK_SLIDE, EARTHQUAKE, ROAR, ANCIENTPOWER
	db 67, GYARADOS,   DRAGON_FANG, EARTHQUAKE, WATERFALL, TWISTER, DRAGONBREATH
