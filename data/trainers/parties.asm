...
FalknerGroup:
	...
	db 50, FEAROW,		SHARP_BEAK,	  DRILL_PECK, PURSUIT, DETECT, STEEL_WING
	db 52, NOCTOWL,		GOLD_BERRY,   SHADOW_BALL, HYPNOSIS, NIGHTMARE, FLY
	db 52, SKARMORY,	METAL_COAT,	  DRILL_PECK, PURSUIT, SKY_ATTACK, STEEL_WING
	db 54, MURKROW,		SHARP_BEAK,	  MEAN_LOOK, FAINT_ATTACK, NIGHT_SHADE, THUNDER_WAVE
	db 48, XATU,		TWISTEDSPOON, PSYCHIC_M, CONFUSE_RAY, NIGHT_SHADE, PROTECT
	db 56, PIDGEOT,     SHARP_BEAK,	  RETURN, MUD_SLAP, SWAGGER, DOUBLE_TEAM
	db -1 ; end
...
WhitneyGroup:
	...
	db 52, GIRAFARIG,	TWISTEDSPOON,   HYPER_BEAM, BATON_PASS, PSYCHIC_M, SHADOW_BALL
	db 50, LICKITUNG,	PINK_BOW,  		FLAMETHROWER, ICE_BEAM, THUNDERBOLT, HYPER_BEAM
	db 54, FURRET,		PINK_BOW,  		SURF, ICE_BEAM, DOUBLE_TEAM, REST
	db 54, BLISSEY,		MIRACLEBERRY,   DOUBLE_EDGE, COUNTER, SOFTBOILED, THUNDER_WAVE
	db 52, CLEFABLE,    PINK_BOW, 		FIRE_BLAST, THUNDER, BLIZZARD, METRONOME
	db 58, MILTANK,     MIRACLEBERRY, 	ROLLOUT, ATTRACT, BODY_SLAM, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 56, SCIZOR,    	METAL_COAT,	  		QUICK_ATTACK, METAL_CLAW, FURY_CUTTER, SWORDS_DANCE
	db 48, BUTTERFREE,  TWISTEDSPOON,  	  	PSYBEAM, POISONPOWDER, STUN_SPORE, MEGA_DRAIN
	db 52, ARIADOS,		TWISTEDSPOON,	  	PSYCHIC_M, SPIDER_WEB, SLUDGE_BOMB, GIGA_DRAIN
	db 55, PINSIR,	    SILVERPOWDER,   	EARTHQUAKE, GUILLOTINE, FURY_CUTTER, PIN_MISSILE
	db 54, HERACROSS,	SILVERPOWDER,	  	MEGAHORN, DETECT, COUNTER, EARTHQUAKE
	db 52, YANMA,		MIRACLE_SEED,	  	TOXIC, GIGA_DRAIN, DETECT, ANCIENTPOWER
	db -1 ; end
...
MortyGroup:
	...
	db 52, GASTLY,     SPELL_TAG, 	SUBSTITUTE, THUNDERBOLT, DESTINY_BOND, SHADOW_BALL
	db 52, HAUNTER,    SPELL_TAG, 	SUBSTITUTE, PAIN_SPLIT,  HYPNOSIS, NIGHT_SHADE
	db 52, NOCTOWL,	   SPELL_TAG, 	REFLECT, 	  HYPNOSIS,    TAKE_DOWN, SHADOW_BALL
	db 54, MISDREAVUS, SPELL_TAG, 	PAIN_SPLIT, MEAN_LOOK,   PERISH_SONG, NIGHT_SHADE
	db 57, GENGAR,     SPELL_TAG, 	SUBSTITUTE, SHADOW_BALL, THUNDERBOLT, DESTINY_BOND
	db 57, GENGAR,     SPELL_TAG, 	HYPNOSIS,   SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	...
	db 56, SEEL,      NEVERMELTICE, HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 58, DEWGONG,   NEVERMELTICE, SURF, SLEEP_TALK, ICY_WIND, REST
	db 52, JYNX,	  NEVERMELTICE,	ICE_PUNCH, MEAN_LOOK, PERISH_SONG, ICY_WIND
	db 52, LAPRAS,	  NEVERMELTICE,	ICE_BEAM, HYDRO_PUMP, SAFEGUARD, ATTRACT
	db 54, CLOYSTER,  NEVERMELTICE,	SPIKES, SURF, PROTECT, ICY_WIND
	db 60, PILOSWINE, NEVERMELTICE, ICY_WIND, EARTHQUAKE, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 52, MAGNEMITE, MAGNET, THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 56, MAGNETON,  MAGNET, THUNDERBOLT, ZAP_CANNON, LOCK_ON, MIRROR_COAT
	db 52, SKARMORY,  METAL_COAT,	  DRILL_PECK, SPIKES, SKY_ATTACK, STEEL_WING
	db 50, SNEASEL,	METAL_COAT,	  METAL_CLAW, ICY_WIND, BEAT_UP, DOUBLE_TEAM
	db 52, FORRETRESS,	METAL_COAT,	  SPIKES, PROTECT, SANDSTORM, DOUBLE_TEAM
	db 62, STEELIX,   METAL_COAT,  ROAR, CRUNCH, ROCK_SLIDE, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 54, MACHAMP, 	BLACKBELT_I,  ATTRACT, CROSS_CHOP, THUNDERPUNCH, HI_JUMP_KICK
	db 52, HITMONCHAN, 	BLACKBELT_I,  SWAGGER, COUNTER, DOUBLE_TEAM, MACH_PUNCH
	db 55, HITMONLEE, 	BLACKBELT_I,  ROCK_SMASH, HI_JUMP_KICK, FORESIGHT, DOUBLE_TEAM
	db 54, HITMONTOP, 	BLACKBELT_I,  ROCK_SMASH, TRIPLE_KICK, DETECT, RAPID_SPIN
	db 56, PRIMEAPE, 	BLACKBELT_I,  SWAGGER, THUNDERPUNCH, CROSS_CHOP, FURY_SWIPES
	db 60, POLIWRATH,   BLACKBELT_I,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
ClairGroup:
	...
	db 56, GYARADOS,   DRAGON_FANG, EARTHQUAKE, WATERFALL, TWISTER, DRAGONBREATH
	db 52, DRAGONAIR,  DRAGON_FANG, THUNDER_WAVE, THUNDERBOLT, FLAMETHROWER, DRAGONBREATH
	db 52, AERODACTYL, DRAGON_FANG, ROCK_SLIDE, EARTHQUAKE, ROAR, ANCIENTPOWER
	db 56, DRAGONITE,  DRAGON_FANG, THUNDER, SAFEGUARD, HYPER_BEAM, DRAGONBREATH
	db 52, CHARIZARD,  DRAGON_FANG, FLAMETHROWER, WING_ATTACK, SLASH, DRAGONBREATH
	db 60, KINGDRA,    DRAGON_FANG, ICE_BEAM, HYDRO_PUMP, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
WillGroup:
	...
	; WILL (2)
	db "WILL@", TRAINERTYPE_MOVES
	db 58, XATU,       REFLECT, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 60, JYNX,       DREAM_EATER, LOVELY_KISS, BLIZZARD, PSYCHIC_M
	db 60, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 60, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 61, ESPEON,     PROTECT, HIDDEN_POWER, MORNING_SUN, PSYCHIC_M
	db 62, XATU,       QUICK_ATTACK, SHADOW_BALL, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	; BRUNO (1)
	db "BRUNO@", TRAINERTYPE_MOVES
	db 62, HITMONTOP,  TRIPLE_KICK, QUICK_ATTACK, EARTHQUAKE, COUNTER
	db 61, HITMONLEE,  SWAGGER, REVERSAL, HI_JUMP_KICK, FORESIGHT
	db 61, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, SUBSTITUTE, MACH_PUNCH
	db 62, ONIX,       BIDE, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 64, POLIWRATH,  SURF, SUBMISSION, MIND_READER, ROCK_SMASH
	db 64, MACHAMP,    ROCK_SLIDE, FORESIGHT, DYNAMICPUNCH, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	; KAREN (2)
	db "KAREN@", TRAINERTYPE_MOVES
	db 62, SNEASEL,    BEAT_UP, ICE_PUNCH, FAINT_ATTACK, MEAN_LOOK
	db 64, UMBREON,    CURSE, CONFUSE_RAY, FAINT_ATTACK, PURSUIT
	db 62, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 62, GENGAR,     SHADOW_BALL, HYPNOSIS, CURSE, DESTINY_BOND
	db 64, MURKROW,    THUNDER_WAVE, WHIRLWIND, DRILL_PECK, FAINT_ATTACK
	db 63, HOUNDOOM,   ROAR, SLUDGE_BOMB, FLAMETHROWER, CRUNCH
	db -1 ; end
...
KogaGroup:
	...
	; KOGA (2)
	db "KOGA@", TRAINERTYPE_MOVES
	db 61, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, TOXIC, GIGA_DRAIN
	db 63, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 60, WEEZING,    SMOKESCREEN, SUBSTITUTE, SLUDGE_BOMB, EXPLOSION
	db 62, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 62, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 64, CROBAT,     DOUBLE_TEAM, MEAN_LOOK, FLY, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	; CHAMPION (2)
	db "LANCE@", TRAINERTYPE_MOVES
	db 68, GYARADOS,   ICY_WIND, THUNDER_WAVE, WATERFALL, HYPER_BEAM
	db 72, DRAGONAIR,  THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	db 72, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 73, AMPHAROS,   THUNDER_WAVE, LIGHT_SCREEN, THUNDER, HYPER_BEAM
	db 68, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 75, DRAGONITE,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
SchoolboyGroup:
	...
	db 52, GROWLITHE,  SUNNY_DAY, LEER, TAKE_DOWN, FLAME_WHEEL
...
BirdKeeperGroup:
	...
	db 56, PIDGEOT,    SWIFT, DETECT, STEEL_WING, FLY
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 59, RAPIDASH,   FOCUS_BAND,   STOMP, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
	...
	db 54, STARMIE,    NO_ITEM,      DOUBLE_TEAM, PSYCHIC_M, WATERFALL, CONFUSE_RAY
	...
	; COOLTRAINERF (22)
	db "ROSE@", TRAINERTYPE_ITEM_MOVES
	db 75, UMBREON,	   BLACKGLASSES, PURSUIT, FAINT_ATTACK, MOONLIGHT, 	  SCREECH
	db 70, MURKROW,	   BLACKGLASSES, PURSUIT, FAINT_ATTACK, NIGHT_SHADE,  MEAN_LOOK
	db 77, HOUNDOOM,   CHARCOAL,	 ROAR,	  FAINT_ATTACK, FLAMETHROWER, CRUNCH
	db 75, SNEASEL,    BLACKGLASSES, SCREECH, FAINT_ATTACK, BEAT_UP,	  METAL_CLAW
	db 78, TYRANITAR,  PINK_BOW,	 ROCK_SLIDE, CRUNCH, 	EARTHQUAKE,   HYPER_BEAM
	db 80, GENGAR,	   SPELL_TAG,	 NIGHT_SHADE,  SHADOW_BALL, HYPNOSIS, DESTINY_BOND
	db -1 ;end
	
	; COOLTRAINERF (23)
	db "ROSE@", TRAINERTYPE_ITEM_MOVES
	db 80, UMBREON,	   BLACKGLASSES, PURSUIT, FAINT_ATTACK, MOONLIGHT, 	  SCREECH
	db 78, MURKROW,	   BLACKGLASSES, PURSUIT, FAINT_ATTACK, NIGHT_SHADE,  MEAN_LOOK
	db 85, HOUNDOOM,   CHARCOAL,	 ROAR,	  FAINT_ATTACK, FLAMETHROWER, CRUNCH
	db 83, SNEASEL,    BLACKGLASSES, SCREECH, FAINT_ATTACK, BEAT_UP,	  METAL_CLAW
	db 90, TYRANITAR,  PINK_BOW,	 ROCK_SLIDE, CRUNCH, 	EARTHQUAKE,   HYPER_BEAM
	db 90, GENGAR,	   SPELL_TAG,	 EXPLOSION,  SHADOW_BALL, HYPNOSIS, DESTINY_BOND
	db -1 ;end
...
HikerGroup:
	...
	db 52, DUGTRIO,    MAGNITUDE, DIG, MUD_SLAP, SLASH
...
PicnickerGroup:
	...
	db 53, PONYTA,     DOUBLE_TEAM, STOMP, FIRE_SPIN, SUNNY_DAY
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 61, CLEFAIRY,   METRONOME, ENCORE, MOONLIGHT, MINIMIZE
	db -1 ; end
...
BlueGroup:
	...
	; BLUE (2)
	db "BLUE@", TRAINERTYPE_MOVES
	db 66, PIDGEOT,    STEEL_WING, RETURN, WING_ATTACK, MIRROR_MOVE
	db 64, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 66, RHYDON,     MEGAHORN, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 70, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 70, EXEGGUTOR,  PSYCHIC_M, EXPLOSION, EGG_BOMB, SOLARBEAM
	db 70, ARCANINE,   CRUNCH, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
