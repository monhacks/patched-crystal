...
CooltrainerFGroup:
	...
	; COOLTRAINERF (22)
	db "SYLVIA@", TRAINERTYPE_ITEM_MOVES
	...
	db 90, GENGAR,	   SPELL_TAG,	 NIGHT_SHADE,  SHADOW_BALL, HYPNOSIS, DESTINY_BOND
	db -1 ;end
...
SuperNerdGroup:
	...
	db 90, KINGDRA, 	SCOPE_LENS, 	HYDRO_PUMP, 	DRAGONBREATH, 	HYPER_BEAM,		CURSE 
	db 92, SLOWKING, 	TWISTEDSPOON, 	PSYCHIC_M, 		SURF, 			DISABLE, 		ZAP_CANNON
	db 94, STEELIX, 	METAL_COAT, 	IRON_TAIL, 		CRUNCH, 		EARTHQUAKE, 	CURSE
	db 92, ESPEON, 		SCOPE_LENS, 	PSYCHIC_M, 		SHADOW_BALL, 	MORNING_SUN,	DOUBLE_TEAM
	db 95, MISDREAVUS, 	SPELL_TAG, 		SHADOW_BALL,	PAIN_SPLIT, 	MEAN_LOOK, 		PERISH_SONG
	db 100, FERALIGATR, BRIGHTPOWDER,	DYNAMICPUNCH,	HYDRO_PUMP,		CRUNCH,			RAZOR_WIND
	db -1, ;end

	; SUPER_NERD (16)
	db "JOHNNY@", TRAINERTYPE_ITEM_MOVES
	db 100, BLISSEY, LUCKY_EGG,   SWAGGER, SPLASH, TAIL_WHIP, BELLY_DRUM
	db 100, BLISSEY, LUCKY_EGG,   SWAGGER, SPLASH, TAIL_WHIP, BELLY_DRUM
	db 100, BLISSEY, LUCKY_EGG,   SWAGGER, SPLASH, TAIL_WHIP, BELLY_DRUM
	db 100, BLISSEY, LUCKY_EGG,   SWAGGER, SPLASH, TAIL_WHIP, BELLY_DRUM
	db 100, BLISSEY, LUCKY_EGG,   SWAGGER, SPLASH, TAIL_WHIP, BELLY_DRUM
