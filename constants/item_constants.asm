...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const MAX_REPEL    ; 2b
	const DIRE_HIT     ; 2c
	const DOME_FOSSIL  ;const ITEM_2D      ; 2d
	const FRESH_WATER  ; 2e
	const SODA_POP     ; 2f
	const LEMONADE     ; 30
	const X_ATTACK     ; 31
	const HELIX_FOSSIL ;const ITEM_32      ; 32
	const X_DEFEND     ; 33
	const X_SPEED      ; 34
	const X_SPECIAL    ; 35
	const COIN_CASE    ; 36
	...
	const OLD_AMBER    ;const ITEM_5A      ; 5a
	...
	const POCKET_PC	   ;const ITEM_64      ; 64
